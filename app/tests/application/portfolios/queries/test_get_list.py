...
async def test_get_portfolio_list_query_with_search(
    ...
    portfolio1 = PortfolioEntity(
        ...
        poster_alt=portfolio1.poster_alt,
        ...
        solution_image_left_alt=portfolio1.solution_image_left_alt,
        solution_image_right=portfolio1.solution_image_right,
        solution_image_right_alt=portfolio1.solution_image_right_alt,
    ...
    portfolio2 = PortfolioEntity(
        ...
        poster_alt=portfolio2.poster_alt,
        ...
        solution_image_left_alt=portfolio2.solution_image_left_alt,
        solution_image_right=portfolio2.solution_image_right,
        solution_image_right_alt=portfolio2.solution_image_right_alt,
